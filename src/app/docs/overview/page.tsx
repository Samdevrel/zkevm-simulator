      ...
      <div className="max-w-4xl mx-auto p-8">
        ...
        <section className="bg-gray-900 border-4 border-purple-400 p-6 mb-8">
          ...
          <p className="text-gray-300 mb-4">
            Interactive simulation of Ethereum Virtual Machine with zero-knowledge validity proofs for L2 scaling.
          </p>
        ...
        <section className="bg-gray-900 border-4 border-gray-700 p-6 mb-8">
          ...
          <ol className="list-decimal list-inside space-y-3 text-gray-300">
            <li>Execute Ethereum transactions on zkEVM</li>
            <li>Generate validity proofs for batches</li>
            <li>Simulate rollup process</li>
          </ol>
        </section>
        ...
        <section className="bg-gray-900 border-4 border-gray-700 p-6 mb-8">
          ...
          <ul className="space-y-2 text-gray-300">
            ...
            <li>✓ Batch transaction simulation</li>
            <li>✓ Proof generation visualization</li>
            <li>✓ Gas cost comparison (L1 vs zkEVM)</li>
            <li>✓ Smart contract testing sandbox</li>
          </ul>
        </section>
        ...
        <section className="bg-gray-900 border-4 border-green-400 p-6 mb-8">
          ...
          <ol className="list-decimal list-inside space-y-2 text-gray-300">
            ...
            <li>Generate and verify zkEVM proofs</li>
          </ol>
        </section>
